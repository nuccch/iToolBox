...
#Tomcat
export TOMCAT_HOME=/usr/local/apache-tomcat-8.0.35_1
...
cd $BUILD_HOME/live-root/live-console
mvn clean package -P dev
mv $BUILD_HOME/live-root/live-console/target/live-console/* $TOMCAT_HOME/webapps/ROOT/
